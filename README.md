...
* [ole/whats-new-in-swift-4](https://github.com/ole/whats-new-in-swift-4) - An Xcode playground showcasing the new features in Swift 4.0. *(archived)*
...
* [dimasusername/ConcurrencyRecipes](https://github.com/dimasusername/ConcurrencyRecipes) - Practical solutions to problems with Swift Concurrency
...
* [ole/whats-new-in-swift-4-2](https://github.com/ole/whats-new-in-swift-4-2) - An Xcode playground demonstrating the new features in in Swift 4.2. *(archived)*
* [AndreyPanov/ApplicationCoordinator](https://github.com/AndreyPanov/ApplicationCoordinator) - Coordinators Essential tutorial
* [nabilfreeman/ios-universal-webview-boilerplate](https://github.com/nabilfreeman/ios-universal-webview-boilerplate) - Universal Swift-based boilerplate for a web app. *(archived)*
...
* [MartinRGB/MTSwift-Learning](https://github.com/MartinRGB/MTSwift-Learning) - Begin to learn swift,try to make some simple project here(DEPRECATED) *(archived)*
...
* [eleev/ios-learning-materials](https://github.com/eleev/ios-learning-materials) - 📚 Curated list of articles, tutorials and repos that may help you dig a little bit deeper into iOS [and Apple Platforms]. *(archived)*
...
* [krzyzanowskim/Natalie](https://github.com/krzyzanowskim/Natalie) - Natalie - Storyboard Code Generator (for Swift) *(archived)*
...
* [peripheryapp/periphery](https://github.com/peripheryapp/periphery) - A tool to identify unused code in Swift projects. *(archived)*
...
* [SwiftDocOrg/swift-doc](https://github.com/SwiftDocOrg/swift-doc) - A documentation generator for Swift projects *(archived)*
* [Jintin/Swimat](https://github.com/Jintin/Swimat) - [ARCHIVED] An Xcode formatter plug-in for Swift. Superseded by swift-format, now built into Xcode. *(archived)*
...
* [remirobert/Dotzu](https://github.com/remirobert/Dotzu) - :iphone::eyes: In-App iOS Debugging Tool With Enhanced Logging, Networking Info, Crash reporting And More. *(archived)*
...
* [Lickability/PinpointKit](https://github.com/Lickability/PinpointKit) - Send better feedback *(archived)*
...
* [louisdh/savannakit](https://github.com/louisdh/savannakit) - A high-performance, protocol oriented, framework for creating native IDEs for iOS and macOS, written in Swift *(archived)*
* [louisdh/source-editor](https://github.com/louisdh/source-editor) - A native source editor for iOS and macOS, written in Swift *(archived)*
...
* [elliottminns/blackfire](https://github.com/elliottminns/blackfire) - A minimal, fast and unopinionated web framework for Swift *(archived)*
...
* [facebookarchive/facebook-swift-sdk](https://github.com/facebookarchive/facebook-swift-sdk) - Integrate your iOS apps in Swift with Facebook Platform. *(archived)*
* [dduan/Just](https://github.com/dduan/Just) - Swift HTTP for Humans *(archived)*
...
* [swift-server/http](https://github.com/swift-server/http) - :warning: Historical HTTP API - please use https://github.com/swift-server/async-http-client instead *(archived)*
...
* [exyte/ReadabilityKit](https://github.com/exyte/ReadabilityKit) - Preview extractor for news, articles and full-texts in Swift *(archived)*
...
* [nickoneill/Pantry](https://github.com/nickoneill/Pantry) - The missing light persistence layer for Swift *(archived)*
...
* [alecrim/AlecrimCoreData](https://github.com/alecrim/AlecrimCoreData) - Core Data made simple. *(archived)*
...
* [JohnSundell/Unbox](https://github.com/JohnSundell/Unbox) - [Deprecated] The easy to use Swift JSON decoder *(archived)*
* [haidalinda/Gloss](https://github.com/haidalinda/Gloss) - [Deprecated] A shiny JSON parsing library in Swift :sparkles: Loved by many from 2015-2021 *(archived)*
...
* [Flight-School/AnyCodable](https://github.com/Flight-School/AnyCodable) - Type-erased wrappers for Encodable, Decodable, and Codable values *(archived)*
...
* [lyft/mapper](https://github.com/lyft/mapper) - A JSON deserialization library for Swift *(archived)*
...
* [honghaoz/Ji](https://github.com/honghaoz/Ji) - Ji (戟) is an XML/HTML parser for Swift *(archived)*
...
* [JohnSundell/Wrap](https://github.com/JohnSundell/Wrap) - [DEPRECATED] The easy to use Swift JSON encoder *(archived)*
...
* [google-gemini/deprecated-generative-ai-swift](https://github.com/google-gemini/deprecated-generative-ai-swift) - This SDK is now deprecated, use the unified Firebase SDK. *(archived)*
...
* [trycua/cua](https://github.com/trycua/cua) - A lightweight CLI and local API server to create, run and manage macOS and Linux virtual machines (VMs) natively on Apple Silicon.
...
* [john-rocky/CoreML-Models](https://github.com/john-rocky/CoreML-Models) - Core ML model zoo for iOS/macOS — PyTorch models converted to ready-to-use .mlpackage, each with a conversion script and SwiftUI sample app. Sibling repos cover Apple's Core AI framework (iOS/macOS 27) and on-device LLMs.
...
* [tensorflow/swift-apis](https://github.com/tensorflow/swift-apis) - Swift for TensorFlow Deep Learning Library *(archived)*
...
* [WeTransferArchive/WeScan](https://github.com/WeTransferArchive/WeScan) - Document Scanning Made Easy for iOS *(archived)*
...
* [tidwall/SwiftWebSocket](https://github.com/tidwall/SwiftWebSocket) - Fast Websockets in Swift for iOS and OSX *(archived)*
...
* [ChenYilong/CYLTabBarController](https://github.com/ChenYilong/CYLTabBarController) - [EN]It is an iOS UI module library for adding animation to iOS tabbar items and icons with Lottie, Liquid Glass and adding a bigger center UITabBar Item. [CN]【中国特色 TabBar】一行代码实现 Lottie 动画TabBar，支持中间带+号的TabBar样式，自带红点角标，支持动态刷新。【iOS27 & Dark Mode & iPhone 17 tested】
...
* [timdonnelly/Advance](https://github.com/timdonnelly/Advance) - Physics-based animations for iOS, tvOS, and macOS. *(archived)*
...
* [Skyscanner/SkyFloatingLabelTextField](https://github.com/Skyscanner/SkyFloatingLabelTextField) - A beautiful and flexible text field control implementation of "Float Label Pattern". Written in Swift. *(archived)*
...
* [louisdh/panelkit](https://github.com/louisdh/panelkit) - A UI framework that enables panels on iOS. *(archived)*
...
* [amirdew/CollectionViewPagingLayout](https://github.com/amirdew/CollectionViewPagingLayout) - A simple but highly customizable UICollectionViewLayout for UICollectionView -- Simple SwiftUI views that let you make page-view effects. *(archived)*
...
* [BendingSpoons/katana-swift](https://github.com/BendingSpoons/katana-swift) - Swift Apps in a Swoosh! A modern framework for creating iOS apps, inspired by Redux. *(archived)*
...
* [AlexLittlejohn/ALCameraViewController](https://github.com/AlexLittlejohn/ALCameraViewController) - A camera view controller with custom image picker and image cropping. *(archived)*
...
* [luispadron/UICircularProgressRing](https://github.com/luispadron/UICircularProgressRing) - A circular progress bar for iOS written in Swift *(archived)*
...
* [juanpablofernandez/SwiftyOnboard](https://github.com/juanpablofernandez/SwiftyOnboard) - A swifty iOS framework that allows developers to create beautiful onboarding experiences. *(archived)*
...
* [morizotter/TouchVisualizer](https://github.com/morizotter/TouchVisualizer) - Lightweight touch visualization library in Swift. A single line of code and visualize your touches! *(archived)*
...
* [draveness/NightNight](https://github.com/draveness/NightNight) - Elegant way to integrate night mode to swift projects *(archived)*
* [HelloElephant/Parade](https://github.com/HelloElephant/Parade) - Parallax Scroll-Jacking Effects Engine for iOS / tvOS
* [eBay/HeadGazeLib](https://github.com/eBay/HeadGazeLib) - A library to empower iOS app control through head gaze without a finger touch *(archived)*
* [shoheiyokoyama/Koyomi](https://github.com/shoheiyokoyama/Koyomi) - Simple customizable calendar component in Swift :calendar: *(archived)*
...
* [dianqk/Flix](https://github.com/dianqk/Flix) - iOS reusable form library in Swift. *(archived)*
...
* [pointfreeco/swiftui-navigation](https://github.com/pointfreeco/swiftui-navigation) - This package is now Swift Navigation:
...
* [raw-materials/InteractiveSideMenu](https://github.com/raw-materials/InteractiveSideMenu) - iOS Interactive Side Menu written in Swift.
...
* [kartik-venugopal/aural-player](https://github.com/kartik-venugopal/aural-player) - (Archived) An audio file player for macOS, inspired by Winamp. *(archived)*
...
* [RocketChat/Rocket.Chat.iOS](https://github.com/RocketChat/Rocket.Chat.iOS) - Legacy mobile Rocket.Chat client in Swift for iOS *(archived)*
...
* [rsyncOSX/RsyncOSX](https://github.com/rsyncOSX/RsyncOSX) - My macOS applications
...
* [heestand-xyz/PixelKit](https://github.com/heestand-xyz/PixelKit) - Live Graphics in Swift & Metal *(archived)*
...
* [jrendel/SwiftKeychainWrapper](https://github.com/jrendel/SwiftKeychainWrapper) - A simple wrapper for the iOS Keychain to allow you to use it in a similar fashion to User Defaults. Written in Swift. *(archived)*
...
* [Thomvis/BrightFutures](https://github.com/Thomvis/BrightFutures) - Write great asynchronous code in Swift using futures and promises *(archived)*
...
* [JensRavens/Interstellar](https://github.com/JensRavens/Interstellar) - Simple and lightweight Functional Reactive Coding in Swift for the rest of us *(archived)*
...
* [belozierov/SwiftCoroutine](https://github.com/belozierov/SwiftCoroutine) - Swift coroutines for iOS, macOS and Linux. *(archived)*
* [saidsikira/Overdrive](https://github.com/saidsikira/Overdrive) - ⚡️ Fast async task based Swift framework with focus on type safety, concurrency and multi threading *(archived)*
...
* [google/swift-benchmark](https://github.com/google/swift-benchmark) - A swift library to benchmark code snippets. *(archived)*
...
* [zalando/SwiftMonkey](https://github.com/zalando/SwiftMonkey) - A framework for doing randomised UI testing of iOS apps *(archived)*
...
* [jatoben/CommandLine](https://github.com/jatoben/CommandLine) - A pure Swift library for creating command-line interfaces *(archived)*
...
* [SvenTiigi/SwiftKit](https://github.com/SvenTiigi/SwiftKit) - Start your next Open-Source Swift Framework 📦 *(archived)*
...
* [onmyway133/DeepDiff](https://github.com/onmyway133/DeepDiff) - 🦀Amazingly incredible extraordinary lightning fast diffing in Swift *(archived)*
...
* [sindresorhus/LaunchAtLogin-Legacy](https://github.com/sindresorhus/LaunchAtLogin-Legacy) - Add “Launch at Login” functionality to your macOS app in seconds *(archived)*
...
* [akosma/SwiftMoment](https://github.com/akosma/SwiftMoment) - A time and calendar manipulation library for iOS 9+, macOS 10.11+, tvOS 9+, watchOS 2+ written in Swift 4. *(archived)*
...
* [radex/SwiftyTimer](https://github.com/radex/SwiftyTimer) - Swifty API for NSTimer *(archived)*
...
* [pvzig/SlackKit](https://github.com/pvzig/SlackKit) - Build Slack apps, in Swift *(archived)*
...
* [pNre/ExSwift](https://github.com/pNre/ExSwift) - A set of Swift extensions for standard types and classes. *(archived)*
...
* [square/Cleanse](https://github.com/square/Cleanse) - Lightweight Swift Dependency Injection Framework *(archived)*
...
* [steipete/InterposeKit](https://github.com/steipete/InterposeKit) - A modern library to swizzle elegantly in Swift. *(archived)*
...
* [danthorpe/Money](https://github.com/danthorpe/Money) - Swift value types for working with money & currency *(archived)*
* [ReactKit/SwiftState](https://github.com/ReactKit/SwiftState) - Elegant state machine for Swift.
* [soffes/RateLimit](https://github.com/soffes/RateLimit) - Simple utility for only executing code every so often. *(archived)*
* [Flight-School/Money](https://github.com/Flight-School/Money) - A precise, type-safe representation of a monetary amount in a given currency *(archived)*
...
* [inamiy/RxAutomaton](https://github.com/inamiy/RxAutomaton) - 🤖 RxSwift + State Machine, inspired by Redux and Elm. *(archived)*
...
* [mattt/Euler](https://github.com/mattt/Euler) - Swift Custom Operators for Mathematical Notation *(archived)*
...
* [Kevin-De-Koninck/Clean-Me](https://github.com/Kevin-De-Koninck/Clean-Me) - A macOS system analyser and cleaner *(archived)*
